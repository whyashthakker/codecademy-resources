...
export default function Header({ searchTerm, setSearchTerm }: HeaderProps) {
  return (
    <header
      className="w-full shadow-sm border-b border-gray-100 z-20 relative"
    ...
    >
      <div className="container mx-auto px-6 py-4 flex items-center justify-between">
        ...
        <div className="flex items-center gap-3">
          <div className="bg-gray-900 text-white px-3 py-2 rounded-lg flex items-center gap-1 cursor-pointer select-none">
